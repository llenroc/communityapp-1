...
namespace TechReady.Views
{
    ...
    /// </summary>
    public sealed partial class WatchedVideosListPage : Page
    {
        ...
        public WatchedVideosListPage()
        {
            ...
            this.DataContext = new WatchedVideosListPageViewModel();
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            await ((WatchedVideosListPageViewModel)this.DataContext).GetWatchedVideos();
        }
        ...
        private void UnFavLearningResource_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (sen != null)
            {
                ...
                ((WatchedVideosListPageViewModel) this.DataContext).Resources.Remove(lr);
            }
        }
    }
}
